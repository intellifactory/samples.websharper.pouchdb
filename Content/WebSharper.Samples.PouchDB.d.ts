    ...
    module Samples {
        module PouchDB {
            module Client {
                module Defaults {
                    var PopulateDb : {
                        (db: __ABBREV.__PouchDB.PouchDB1<any>): any;
                    };
                    var codes : {
                        (): __ABBREV.__List.T<any>;
                    };
                ...
                interface Snippet {
                    Language: __ABBREV.__Client.Language;
                    Code: string;
                }
                var LangName : {
                    (_arg1: __ABBREV.__Client.Language): string;
                };
                var LangMode : {
                    (_arg1: __ABBREV.__Client.Language): string;
                };
                var mkSnippet : {
                    (lang: __ABBREV.__Client.Language, code: string): any;
                };
                var Languages : {
                    (s: string): __ABBREV.__List.T<__ABBREV.__Client.Language>;
                };
                var MkPanel : {
                    (id: string, parent: string, title: string, body: __ABBREV.__Client1.Pagelet): __ABBREV.__List.T<__ABBREV.__Client1.Element>;
                };
                var SnippetToString : {
                    (ann: any, d: __ABBREV.__JavaScript.Date): string;
                };
                var CodePre : {
                    (code: string): __ABBREV.__Client1.Element;
                };
                var RefreshSnippets : {
                    (container: __ABBREV.__Client1.Element): void;
                };
                var db : {
                    (): __ABBREV.__PouchDB.PouchDB1<any>;
                };
                var Data : {
                    (): {
                        (x: string): {
                            (x: string): __ABBREV.__Client1.Pagelet;
                        };
                    };
                };
                var AccordionId : {
                ...
                var Accordions : {
                    (): __ABBREV.__Client1.Element;
                };
                var cm : {
                    (): __ABBREV.__WebSharper.OptionProxy<__ABBREV.__CodeMirror.CodeMirror>;
                };
                var AdderPiglet : {
                    (): __ABBREV.__Client1.Element;
                };
            ...
            module Controls {
                var InputOption : {
                    (stream: __ABBREV.__Piglets.Stream<__ABBREV.__WebSharper.OptionProxy<string>>): __ABBREV.__Client1.Element;
                };
                var CodeMirror : {
                    (stream: __ABBREV.__Piglets.Stream<string>): any;
                };
            }
            module Utils {
                var Promise_1_ToAsync : {
                    <_M1>(x0: __ABBREV.__PouchDB.Promise1<_M1>): any;
                };
                var op_BarMultiplyGreater : {
                    <_M1, _M2>(comp: any, fn: {
                        (x: _M1): _M2;
                    }): any;
                };
                var String_StripMargin : {
                    (x: string, sep: string): string;
                };
                var cnst : {
                    <_M1, _M2>(a: _M1, _arg1: _M2): _M1;
                };
                var flip : {
                    <_M1, _M2, _M3>(f: {
                        (x: _M1): {
                ...
                var FormControl : {
                    (name: string, el: __ABBREV.__Client1.Element): __ABBREV.__Client1.Element;
                };
            }
        }
    }
...
declare module __ABBREV {
    ...
    export import __PouchDB = IntelliFactory.WebSharper.PouchDB;
    export import __List = IntelliFactory.WebSharper.List;
    export import __Client = WebSharper.Samples.PouchDB.Client;
    export import __Client1 = IntelliFactory.WebSharper.Html.Client;
    export import __JavaScript = IntelliFactory.WebSharper.JavaScript;
    export import __WebSharper = IntelliFactory.WebSharper;
    export import __CodeMirror = IntelliFactory.WebSharper.CodeMirror;
    export import __Piglets = IntelliFactory.WebSharper.Piglets;
}
