...
(function()
{
 var Global=this,Runtime=this.IntelliFactory.Runtime,WebSharper,Html,Client,Default,List,WebSharper1,Samples,PouchDB,Client1,Option,Piglets,Pervasives,Piglet1,Utils,Builder,Date,String,jQuery,Seq,Controls,Controls1,Operators,T,Defaults,Concurrency,PouchDB1,CodeMirror,Result,Stream1,Strings,Arrays;
 Runtime.Define(Global,{
  WebSharper:{
   Samples:{
    PouchDB:{
     Client:{
      ...
      Accordions:Runtime.Field(function()
      {
       var _this,x;
       _this=Default.Attr();
       x=Client1.AccordionId();
       return Default.Div(List.ofArray([_this.NewAttr("id",x),Default.Attr().Class("panel-group")]));
      }),
      AdderPiglet:Runtime.Field(function()
      {
       ...
       _arg10_=Pervasives.op_LessMultiplyGreater(Pervasives.op_LessMultiplyGreater(Piglet1.Return(function(a)
       {
        return function(b)
        {
       ...
       }),Piglet1.Yield("")),_builder_.Bind(Piglet1.Yield({
        $:0
       }),function(_arg1)
       {
        return _arg1.$==3?_builder_.ReturnFrom(Piglet1.Map(function(a)
        {
         return{
          $:3,
          $0:a.$0
         ...
         $:1,
         $0:""
        }))):_builder_.ReturnFrom(Piglet1.Map(function(_arg10_1)
        {
       ...
       _arg00_=Piglet1.Run(action,_arg10_);
       x1=Piglet1.WithSubmit(_arg00_);
       x2=Piglet1.Run(function(res)
       {
        var d;
        d=Date.now();
        Client1.db().put(res,String(d)).then(function()
        {
         var title,action1,list;
         ...
         list=List.rev(Client1.MkPanel(Global.String(d),Client1.AccordionId(),title,Client1.CodePre(res.Code)));
         Seq.iter(action1,list);
       ...
       return Piglet1.Render(function(x)
       {
        return function(y)
        {
         ...
         {
          var patternInput,textarea,c,x3,_this,_,submit,objectArg,arg00;
          patternInput=Controls.CodeMirror(x);
          textarea=patternInput[0];
          c=patternInput[1];
          x3=List.ofArray([Default.Text("Code")]);
          _this=Default.Tags();
          textarea.AppendN(_this.NewTag("label",x3).Dom);
          _={
           $:1,
           $0:c
          };
          ...
          objectArg=submit["HtmlProvider@33"];
          arg00=submit.get_Body();
          objectArg.AddClass(arg00,"btn btn-primary");
          Operators.OnAfterRender(function()
          {
           return c.setValue("");
          },textarea);
          return Operators.add(Default.Div(List.ofArray([Default.Attr().Class("form-horizontal")])),List.ofArray([y.Chooser(function(stream)
          {
          ...
          }),Controls1.RenderChoice(y,function(strm)
          {
           ...
           $:0
          }))),textarea,submit,Controls1.ShowResult(submitter,function(_arg2)
          {
           return _arg2.$==1?List.map(function(m)
           {
            return Default.Text(m.get_Message());
      ...
      {
       var x;
       x=Operators.add(Default.Pre(List.ofArray([Default.Attr().Class("prettyprint linenums")])),List.ofArray([Default.Text(code)]));
       Operators.OnAfterRender(function()
       {
      ...
      Defaults:{
       PopulateDb:function(db)
       {
        ...
        {
         var x,f1;
         x=Utils["Promise`1.ToAsync"](db.info());
         f1=function(_arg1)
         {
          var list,x1,x2,x3;
          if(_arg1.doc_count===0)
           {
            list=Defaults.codes();
            x1=List.map(Runtime.Tupled(function(_arg2)
            {
             return Utils["Promise`1.ToAsync"](db.put(Client1.mkSnippet(_arg2[0],_arg2[1]),Global.String(Date.now())));
            }),list);
            x2=Concurrency.Parallel(x1);
            return x2;
           }
          else
           {
        ...
        return Utils.op_BarMultiplyGreater(Concurrency.Delay(f),function()
        {
        });
       },
      ...
      Main:Runtime.Field(function()
      {
       ...
       {
        var x,f1;
        x=Defaults.PopulateDb(Client1.db());
        f1=function()
        {
         var container,_this;
         _this=Default.Attr();
         container=Operators.add(Default.Div(List.ofArray([_this.NewAttr("style","margin: 0 auto; width: 50%; min-width: 400px")])),List.ofArray([Client1.AdderPiglet(),Client1.Accordions()]));
      ...
      MkPanel:function(id,parent,title,body)
      {
       ...
       x="#"+id;
       _this1=Default.Attr();
       return List.ofArray([Operators.add(Default.Div(List.ofArray([Default.Attr().Class("panel-heading")])),List.ofArray([Operators.add(Default.H4(List.ofArray([Default.Attr().Class("panel-title")])),List.ofArray([Operators.add(Default.A(List.ofArray([((Client1.Data())("toggle"))("collapse"),((Client1.Data())("parent"))(parent),_this.NewAttr("href",x)])),List.ofArray([Default.Text(title)]))]))])),Operators.add(Default.Div(List.ofArray([_this1.NewAttr("id",id),Default.Attr().Class("panel-collapse collapse")])),List.ofArray([Operators.add(Default.Div(List.ofArray([Default.Attr().Class("panel-body")])),List.ofArray([body]))]))]);
      },
      RefreshSnippets:function(container)
      {
       ...
       arg00=Utils.op_BarMultiplyGreater(Client1.RenderSnippets(),function(list)
       {
      ...
      RenderSnippets:Runtime.Field(function()
      {
       ...
       {
        var x,f1;
        x=Utils["Promise`1.ToAsync"](Client1.db().allDocs({
         include_docs:true,
         descending:true
        }));
        f1=function(_arg1)
        {
         var array,x1;
         array=_arg1.rows;
         x1=List.concat(List.map(function(a)
         {
          var title;
     ...
     Controls:{
      CodeMirror:function(stream)
      {
       ...
       cm.on("change",Runtime.Tupled(function(tupledArg)
       {
        return stream.Trigger(Runtime.New(Result,{
         $:0,
         $0:tupledArg[0].getValue()
        }));
       }));
       return[container,cm];
      },
      ...
      {
       var container,folder,mapped,x,cnt,previous;
       container=Default.Div(Runtime.New(T,{
        $:0
       }));
       folder=function()
       ...
       mapped=Stream1.Map(function(option)
       {
       ...
       x=Controls1.input("text",function(x1)
       {
        return x1;
       },function(x1)
       {
       ...
       cnt=Utils.FormControl("Language",x);
       previous={
        contents:false
       };
       stream.SubscribeImmediate(function(_arg1)
     ...
     Utils:{
      ...
      {
       var objectArg,arg00,x,_this,x1,_this1;
       objectArg=el["HtmlProvider@33"];
       arg00=el.get_Body();
       objectArg.AddClass(arg00,"form-control");
       _this=Default.Attr();
       x1=el.get_Id();
       x=List.ofArray([_this.NewAttr("for",x1),Default.Text(name)]);
       _this1=Default.Tags();
       return Operators.add(Default.Div(List.ofArray([Default.Attr().Class("form-group")])),List.ofArray([_this1.NewTag("label",x),el]));
      },
      ...
      op_BarMultiplyGreater:function(comp,fn)
      {
       ...
       f=function()
       {
        ...
        return Concurrency.Bind(comp,f1);
       };
       return Concurrency.Delay(f);
      }
     }
 ...
 Runtime.OnInit(function()
 {
  ...
  Samples=Runtime.Safe(WebSharper1.Samples);
  ...
  Builder=Runtime.Safe(Piglet1.Builder);
  Date=Runtime.Safe(Global.Date);
  String=Runtime.Safe(Global.String);
  jQuery=Runtime.Safe(Global.jQuery);
  Seq=Runtime.Safe(WebSharper.Seq);
