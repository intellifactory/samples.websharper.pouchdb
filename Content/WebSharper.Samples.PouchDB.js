...
{
 "use strict";
 var Global,WebSharper,Samples,PouchDB,Client,Operators,Defaults,Obj,Html,Client$1,Pagelet,Operators$1,Tags,AttributeBuilder,Attr,JavaScript,Pervasives,Concurrency,Utils,EventEmitter,List,SC$1,Element,EventTarget,Node,JS,Arrays,TagBuilder,SC$2,AsyncBody,T,Snippet,Language,Piglets,Pervasives$1,Piglet,Builder,Option,Controls,Controls$1,Reader,Choose,Stream,ErrorMessage,WindowOrWorkerGlobalScope,SC$3,Enumerator,Attribute,Implementation,JQueryHtmlProvider,DeprecatedTagBuilder,CT,Scheduler,Object,Strings,Stream$1,Result,Submitter,EventsPervasives,Unchecked,HtmlContainer,Seq,CancellationTokenSource,Error,OperationCanceledException,IntelliFactory,Reactive,HotStream,Id,ConcreteWriter,Text,Collections,Dictionary,SC$4,T$1,Control,FSharpEvent,SC$5,SC$6,DictionaryUtil,Util,Event,Event$1,Events,JQueryEventSupport,List$1,Date,Runtime,console,Math,CodeMirror;
 Global=self;
 WebSharper=Global.WebSharper=Global.WebSharper||{};
 Samples=WebSharper.Samples=WebSharper.Samples||{};
 PouchDB=Samples.PouchDB=Samples.PouchDB||{};
 Client=PouchDB.Client=PouchDB.Client||{};
 Operators=WebSharper.Operators=WebSharper.Operators||{};
 Defaults=Client.Defaults=Client.Defaults||{};
 ...
 Utils=PouchDB.Utils=PouchDB.Utils||{};
 EventEmitter=Global.EventEmitter;
 List=WebSharper.List=WebSharper.List||{};
 SC$1=Global.StartupCode$WebSharper_Samples_PouchDB$Client=Global.StartupCode$WebSharper_Samples_PouchDB$Client||{};
 ...
 Stream$1=Piglets.Stream=Piglets.Stream||{};
 ...
 HtmlContainer=Controls$1.HtmlContainer=Controls$1.HtmlContainer||{};
 ...
 SC$4=Global.StartupCode$WebSharper_Piglets$Controls=Global.StartupCode$WebSharper_Piglets$Controls||{};
 ...
 SC$5=Global.StartupCode$WebSharper_Piglets$Piglets=Global.StartupCode$WebSharper_Piglets$Piglets||{};
 SC$6=Global.StartupCode$WebSharper_Html_Client$Events=Global.StartupCode$WebSharper_Html_Client$Events||{};
 ...
 Client.Main=function()
 {
  ...
  {
   return Concurrency.Bind(Defaults.PopulateDb(Client.db()),function()
   {
    var container,a;
    container=Operators$1.add((a=[Attr.Attr().NewAttr("style","margin: 0 auto; width: 50%; min-width: 400px")],Tags.Tags().NewTag("div",a)),[Client.AdderPiglet(),Client.Accordions()]);
    Client.RefreshSnippets(Client.Accordions());
 ...
 Client.RefreshSnippets=function(container)
 {
  function a(a$1)
  {
   container.AppendI(a$1);
  }
  Concurrency.Start(Utils.op_BarMultiplyGreater(Client.RenderSnippets(),function(l)
  {
   List.iter(a,l);
  }),null);
 };
 Client.Accordions=function()
 {
  SC$1.$cctor();
  return SC$1.Accordions;
 };
 Client.AdderPiglet=function()
 {
  SC$1.$cctor();
  return SC$1.AdderPiglet;
 };
 Client.mkSnippet=function(lang,code)
 {
  return Snippet.New(lang,code);
 };
 Client.RenderSnippets=function()
 {
  SC$1.$cctor();
  return SC$1.RenderSnippets;
 };
 Client.AccordionId=function()
 {
  SC$1.$cctor();
  return SC$1.AccordionId;
 };
 Client.cm=function()
 {
  SC$1.$cctor();
 ...
 Client.LangMode=function(a)
 {
  return a.$==1?"text/x-scala":a.$==2?"text/x-ocaml":a.$==3?a.$0.toLowerCase():"text/x-haskell";
 };
 Client.MkPanel=function(id,parent,title,body)
 {
  var a,a$1,a$2,a$3,a$4;
  return List.ofArray([Operators$1.add((a=[Attr.Attr().NewAttr("class","panel-heading")],Tags.Tags().NewTag("div",a)),[Operators$1.add((a$1=[Attr.Attr().NewAttr("class","panel-title")],Tags.Tags().NewTag("h4",a$1)),[Operators$1.add((a$2=[((Client.Data())("toggle"))("collapse"),((Client.Data())("parent"))(parent),Attr.Attr().NewAttr("href","#"+id)],Tags.Tags().NewTag("a",a$2)),[Tags.Tags().text(title)])])]),Operators$1.add((a$3=[Attr.Attr().NewAttr("id",id),Attr.Attr().NewAttr("class","panel-collapse collapse")],Tags.Tags().NewTag("div",a$3)),[Operators$1.add((a$4=[Attr.Attr().NewAttr("class","panel-body")],Tags.Tags().NewTag("div",a$4)),[body])])]);
 };
 Client.CodePre=function(code)
 {
  var x,a;
  function f(a$1)
  {
  ...
  x=Operators$1.add((a=[Attr.Attr().NewAttr("class","prettyprint linenums")],Tags.Tags().NewTag("pre",a)),[Tags.Tags().text(code)]);
  (function(w)
  {
 ...
 Client.SnippetToString=function(ann,d)
 {
  return Client.LangName(ann.Language)+" - "+d.toLocaleString();
 };
 Client.set_cm=function($1)
 {
  SC$1.$cctor();
  SC$1.cm=$1;
 };
 Client.Languages=function(s)
 {
  return List.ofArray([Language.Haskell,Language.Scala,Language.FSharp,{
   $:3,
   $0:s
  }]);
 };
 Client.LangName=function(a)
 {
  return a.$==1?"Scala":a.$==2?"F#":a.$==3?a.$0:"Haskell";
 };
 ...
 Defaults.PopulateDb=function(db)
 {
  var b;
  return Utils.op_BarMultiplyGreater((b=null,Concurrency.Delay(function()
  {
   return Concurrency.Bind(Utils["Promise`1.ToAsync"](db.info()),function(a)
   {
    function m(l,c)
    {
     return Utils["Promise`1.ToAsync"](db.put(Client.mkSnippet(l,c),Global.String(Date.now())));
    }
    return a.doc_count===0?Concurrency.Parallel(List.map(function($1)
    {
     return m($1[0],$1[1]);
 ...
 Utils.op_BarMultiplyGreater=function(comp,fn)
 {
  var b;
  b=null;
  return Concurrency.Delay(function()
  {
   ...
   {
    return Concurrency.Return(fn(a));
   });
  });
 };
 Utils["Promise`1.ToAsync"]=function(x,u)
 {
 ...
 Utils["String.StripMargin"]=function(x,sep)
 {
  ...
  },Strings.SplitChars(x,["\r","\n"],0)));
 };
 Utils.flip=function(f,a,b)
 {
  return f(b,a);
 };
 Utils.cnst=Global.id;
 Utils.FormControl=function(name,el)
 {
  var a,a$1;
  el.HtmlProvider.AddClass(el.get_Body(),"form-control");
  return Operators$1.add((a=[Attr.Attr().NewAttr("class","form-group")],Tags.Tags().NewTag("div",a)),[(a$1=[Attr.Attr().NewAttr("for",el.get_Id()),Tags.Tags().text(name)],Tags.Tags().NewTag("label",a$1)),el]);
 };
 ...
 SC$1.$cctor=function()
 {
  ...
  function a$1(x,y,submitter)
  {
   var p,textarea,c,a$2,submit,a$3;
   function f(a$4)
   {
    c.setValue("");
   }
   p=Controls.CodeMirror(x);
   textarea=p[0];
   c=p[1];
   textarea.AppendN((a$2=[Tags.Tags().text("Code")],Tags.Tags().NewTag("label",a$2)).Dom);
   Client.set_cm({
    $:1,
    $0:c
   });
   submit=Controls$1.Submit(submitter);
   submit.HtmlProvider.AddClass(submit.get_Body(),"btn btn-primary");
   return Operators$1.add((a$3=[Attr.Attr().NewAttr("class","form-horizontal")],Tags.Tags().NewTag("div",a$3)),[y.Chooser(function(stream)
   {
    return Utils.FormControl("",Controls$1.Select(stream,List.map(function(a$4)
    {
     return[a$4,Client.LangName(a$4)];
    },Client.Languages("Other"))));
   }),Controls$1.RenderChoice(y,Controls.InputOption,Tags.Tags().NewTag("div",[])),(function(w)
   {
    Operators$1.OnAfterRender(f,w);
   }(textarea),textarea),submit,Controls$1.ShowResult(submitter,function(a$4)
   {
    return a$4.$==1?List.map(function(m)
    {
     return Tags.Tags().text(m.get_Message());
    },a$4.$0):T.Empty;
   },Tags.Tags().NewTag("div",[]))]);
  }
  SC$1.codes=List.ofArray([[Language.Haskell,Utils["String.StripMargin"]("\n                        |fibs :: [Integer]\n                        |fibs = 0 : scanl (+) 1 fibs\n                        |\n                        |main = print (take 10 fibs)","|")],[Language.Scala,Utils["String.StripMargin"]("\n                        |object Main extends App {\n                        |    val fibs: Stream[BigInt] = BigInt(0) #:: fibs.scan(BigInt(1))(_ + _)\n                        |    fibs take 10 foreach println\n                        |}","|")],[Language.FSharp,Utils["String.StripMargin"]("\n                        #let fibs =\n                        #    let rec helper a b =\n                        #        seq {\n                        #            yield a;\n                        #            yield! helper b (a + b)\n                        #        }\n                        #    helper 0 1\n                        #\n                        #fibs\n                        #|> Seq.take 10\n                        #|> Seq.iter (printfn \"%d\")","#")]]);
  SC$1.db=new Global.PouchDB("snippetdb");
  SC$1.Data=function(a$2)
  {
   return function(a$3)
   {
    return Attr.Attr().NewAttr("data-"+a$2,a$3);
   };
  };
  SC$1.AccordionId="accordion";
  SC$1.Accordions=(a=[Attr.Attr().NewAttr("id",Client.AccordionId()),Attr.Attr().NewAttr("class","panel-group")],Tags.Tags().NewTag("div",a));
  SC$1.cm=null;
  SC$1.AdderPiglet=Piglet.Render(Runtime.Curried3(a$1),Piglet.Run(function(res)
  {
   var d;
   d=Date.now();
   Client.db().put(res,Global.String(d)).then(function()
   {
    var title;
    title=Client.SnippetToString(res,new Date(d));
    List.iter(function(el)
    {
     var _this,a$2;
     (_this=Global.jQuery(Client.Accordions().Dom),(a$2=el.Dom,_this.prepend.apply(_this,[a$2]))).ready(function()
     {
      return el.Render();
     });
    },List.rev(Client.MkPanel(Global.String(d),Client.AccordionId(),title,Client.CodePre(res.Code))));
    return Global.jQuery(".saved-modal").modal("show");
   });
  },Piglet.WithSubmit(Piglet.Run(function(x)
  {
   var o;
   o=Client.cm();
   o==null?void 0:o.$0.setOption("mode",Client.LangMode(x.Language));
  },Pervasives$1.op_LessMultiplyGreater(Pervasives$1.op_LessMultiplyGreater(Piglet.Return((Runtime.Curried3(Utils.flip))(Client.mkSnippet)),Piglet.Yield("")),(b=Builder.Do,b.Bind(Piglet.Yield(Language.Haskell),function(a$2)
  {
   return a$2.$==3?b.ReturnFrom(Piglet.Map(function(a$3)
   {
    return{
     $:3,
     $0:a$3.$0
    ...
    $:1,
    $0:""
   }))):b.ReturnFrom(Piglet.Map(function(a$3)
   {
    return Utils.cnst(a$2,a$3);
   },Piglet.Yield(null)));
  })))))));
  SC$1.RenderSnippets=(b$1=null,Concurrency.Delay(function()
  {
   var r;
   return Concurrency.Bind(Utils["Promise`1.ToAsync"](Client.db().allDocs((r={},r.include_docs=true,r.descending=true,r))),function(a$2)
   {
    return Concurrency.Return(List.concat(List.map(function(a$3)
    {
     var title;
     title=Client.SnippetToString(a$3.doc,new Date(Global.parseInt(a$3.id,10)));
     return Client.MkPanel(a$3.id,Client.AccordionId(),title,Client.CodePre(a$3.doc.Code));
    },List.ofArray(a$2.rows))));
   });
  }));
 };
 ...
 Snippet.New=function(Language$1,Code)
 {
  return{
   Language:Language$1,
   Code:Code
 ...
 Pervasives$1.op_LessMultiplyGreater=function(f,x)
 {
  var f$1,g;
  return Piglet.New(Stream$1.Ap(f.stream,x.stream),(f$1=f.view,(g=x.view,function(x$1)
  {
   return g(f$1(x$1));
  })));
 };
 ...
 {
  return Piglet.New(new Stream$1.New(new Result({
   $:0,
   $0:x
  }),null),Global.id);
 };
 ...
 Piglet.Choose=function(chooser,choices)
 {
  ...
  c=new Stream.New(chooser,choices,s);
  return Piglet.New(s,function(f)
  {
   return f(c);
  });
 ...
 Piglet.MapResult=function(m,p)
 {
  ...
  out=new Stream$1.New(m(p.stream.get_Latest()),null);
 ...
 Controls.CodeMirror=function(stream)
 {
  var container,cm,r,m;
  container=Tags.Tags().NewTag("div",[]);
  cm=new Global.CodeMirror(function(e)
  {
   return Operators$1.OnAfterRender(function(c)
   {
    c.AppendN(e);
   },container);
  },(r={},r.lineNumbers=true,r));
  m=stream.get_Latest();
  m.$==1?void 0:cm.setValue(m.$0);
  stream.Subscribe(function(a)
  {
   ...
   if(a.$==1)
    ...
    {
     s=a.$0;
     cm.getValue()!==s?cm.setValue(s):void 0;
    }
  });
  CodeMirror.on(cm,"change",function($1)
  {
 ...
 Controls.InputOption=function(stream)
 {
  var container,cnt,previous;
  function f(a,v)
  {
   return v;
  }
  container=Tags.Tags().NewTag("div",[]);
  cnt=Utils.FormControl("Language",Controls$1.input("text",Global.id,Global.id,Stream$1.Map(function(o)
  {
 ...
 Controls$1.Submit=function(submit)
 {
  var x;
  function a(a$1,a$2)
  {
 ...
 Controls$1.Select=function(stream,values)
 {
  var values$1,elts,x,x$1;
  function m(x$3,label)
  {
   var id;
   id=(Controls$1.nextId())();
 ...
 Controls$1.RenderChoice=function(choice,renderIt,container)
 {
  return choice.Choice(new HtmlContainer.New(container),renderIt);
 };
 Controls$1.ShowResult=function(reader,render,container)
 {
  var i,e;
 ...
 Controls$1.nextId=function()
 {
  SC$4.$cctor();
  return SC$4.nextId;
 };
 Controls$1.input=function(type,ofString,toString,stream)
 {
  var i,m;
  function ev(a)
  {
 ...
 Stream=Choose.Stream=Runtime.Class({
  Chooser:function(f)
  {
 ...
 Stream.New=Runtime.Ctor(function(chooser,choice,out)
 {
  var $this;
  $this=this;
  ...
  this.out=out;
  this.pStream=new Stream$1.New(new Result({
   $:1,
   $0:T.Empty
  }),null);
 ...
 Stream$1.Ap=function(sf,sx)
 {
  var out;
  out=new Stream$1.New(Result.Ap(sf.get_Latest(),sx.get_Latest()),null);
 ...
 Stream$1.Map=function(a2b,b2a,s)
 {
  var _s,pa,pb;
  _s=new Stream$1.New(Result.Map(a2b,s.get_Latest()),{
   $:1,
   $0:s.get_Id()
  });
  pa=[s.get_Latest()];
 ...
 Stream$1=Piglets.Stream=Runtime.Class({
  Trigger:function(x)
  {
   this.s.Trigger(x);
  },
 ...
 Stream$1.New=Runtime.Ctor(function(init,id)
 {
  Stream$1.New$1.call(this,HotStream.New$1(init),id);
 },Stream$1);
 Stream$1.New$1=Runtime.Ctor(function(s,id)
 {
 ...
 Submitter.New=Runtime.Ctor(function(input,clearError)
 {
  ...
  this.input=input;
  this.output=new Stream$1.New(new Result({
   $:1,
   $0:T.Empty
  }),null);
 ...
 HtmlContainer=Controls$1.HtmlContainer=Runtime.Class({
 ...
 SC$4.$cctor=function()
 {
  ...
  SC$4.nextId=(current=[0],function()
  {
   current[0]++;
 ...
 SC$6.$cctor=function()
 {
  ...
  SC$6.Events=new JQueryEventSupport.New();
 };
